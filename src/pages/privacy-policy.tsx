		...
		<main className="policy-hero">
			...
			<section className="section section--padding">
				<Preamble light title="Privacy Policy">
					...
					place an order, subscribe to a newsletter, Use Live Chat, Open a
					...
					when a user places an order enters, submits, or accesses their
					...
					<div className="subtitle">Do we use 'cookies'?</div>
					...
					the site.
					<div className="subtitle">Third-party disclosure</div>
					...
					or others' rights, property or safety. However, non-personally
					identifiable visitor information may be provided to other
					parties for marketing, advertising, or other uses.
					<div className="subtitle">Third-party links</div>
					...
					<div className="subtitle">Opting out:</div>
					...
					website. Our Privacy Policy link includes the word 'Privacy' and
					can easily be found on the page specified above. You will be
					...
					including ad networks or plug-ins collect PII from children
					under 13?
					<div className="subtitle">Fair Information Practices</div>
					...
					<ul>
						<li>Within 7 business days We also</li>
					</ul>
					...
					<div className="subtitle">CAN SPAM Act</div>
					...
					<ul>
						<li>
							Follow the instructions at the bottom of each email and
